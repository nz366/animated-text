...
An experimental format is a compatible fromat that unifies features from various caption and lyrics file formats. At its core, it prioritizes readability and basic functionality, even at a minimal level of implementation knowledge. It's basically a virtual plain text file container system with many different files with each of their own independent or co-dependent features. 
...
** `[]` are used to indicate data used by the format reader.**

** `/`  is used as a seperator inside each property block.**
...
| Duet         | WIP           | [-]     | [-]    |           |            |            |
| Idols        | WIP           |         |        |           |            |            |
| File Size    | LOW           | HIGH    | HIGH   | MINIMUM   |  LOW       | LOW        |
| Streamable   | WIP           | TBD     | TBD    |           |            |            |
| Positioning  | WIP           | TBD     | TBD    |           |            | ✅         |
| Sel. Language| WIP           |         |        |           |            |            |

| **Interop.**  | **Animated Text** | **AMLL**  | **TTML** | **LRC**        | **WebVTT** | **Srt** |
|---------------|-------------------|-----------|----------|----------------|------------|---------|
| Animated Text |   ✅              |   WIP     |  WIP     |   ✅ (WIP)     |   WIP      | WIP     |
| AMLL			 |                   |    ✅     |  ✅      |                |            |         |
| TTML 		    |                   |           |  ✅      |   ✅           |            |         |
| LRC				 |    Partial        |           |          |                |            |         |
| WebVTT		    |                   |           |          |                |            |         |
